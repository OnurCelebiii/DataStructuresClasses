...
TYPED_TEST(VectorTest, DoNotFindNonExistingElement) { EXPECT_FALSE(this->vec.isFind(TypeParam())); }
...
TYPED_TEST(VectorTest, IndexOutOfBounds) { EXPECT_THROW(this->vec[1], const char *); }
